 ...
 */
Cookie.get = function (name, options = defaultConfig) {
  ...
  let value = (options.converter || same)(cookies[name]);
 ...
 */
Cookie.set = function (name, value, options = defaultConfig) {
  validateCookieName(name);
 ...
 * @return {string} The created cookie string.
 */
Cookie.remove = function (name, options = defaultConfig) {
  options = options || {};
